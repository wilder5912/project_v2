...
export class GroupProductComponent implements OnInit {
  ...
  private groupProduct: GroupProduct = new GroupProduct();
  private bussine:Bussine = new Bussine();
  private modalRefProductGroup: BsModalRef;
  private options;
  ...
  private sortBy = "nameGroup";
  private sortOrder = "asc";

  constructor(private router: Router , private formBuilder: FormBuilder, public dataService: DataService, public bussineService:BussineService,translate: TranslateService, public loginService: LoginService, public groupProductService:GroupProductService  , private modalService: BsModalService ) {
